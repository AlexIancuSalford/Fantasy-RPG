/*
 * Certainly! The DeferredValue class is a container that wraps a
...
{
    /// <summary>
    /// Bug: Does not work, causes a stack overflow. Do not use, needs fixing
    /// </summary>
    ...
    public class DeferredValue<T>
    {
        ...
        /// </param>
        public DeferredValue(InitializerDelegate initializer)
        {
